      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            // In case of too few previous path points assume tangent
            if(prev_size < 2){
            ...
            // add last two points from the previous path to list for
            // spline fitting
            else{
            ...
            // Fit spline through given points
            tk::spline s;
            ...
            for (int i=1; i<=10-previous_path_x.size(); ++i){
              // Calculate equally distant points on spline linearized
